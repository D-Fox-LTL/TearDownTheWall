...
namespace TearDownTheWall
{
    internal class clsBrick
    {
		...
		bool mblVisible;
		public int mintHowManyLeft;

		//----------------------------
		//Constructor
		//----------------------------
		public clsBrick(Graphics objCanvas, int intXBrick, int intYBrick, int intWidthBrick, int intHeightBrick, int intHowManyLeft)
		{
			...
			mblVisible = true;
			mintHowManyLeft = intHowManyLeft;
		...
		public bool blEndOfGame()
		{
			if (mintHowManyLeft == 0) return true;
			else return false;
		}
    }
}
